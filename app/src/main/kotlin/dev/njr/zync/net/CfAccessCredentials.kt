 ...
 * "this is the zync app" to Cloudflare's edge on the non-interactive paths (/sync/push,
 * /sync/pull, /sync/bootstrap, /pair, /agenda, /blob, /integrations/newz/handoff). It is
 * NOT per-user identity; [dev.njr.zync.replica.DeviceSigner]'s Ed25519 signature remains
 * the actual device/user identity underneath it.
 */
