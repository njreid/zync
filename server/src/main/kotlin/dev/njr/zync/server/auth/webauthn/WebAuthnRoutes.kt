 ...
 */
private val SESSION_EXEMPT = listOf("/auth", "/login", "/assets", "/health", "/sync", "/debug", "/blob", "/metrics", "/pair", "/agenda", "/integrations", "/api", "/mcp", "/favicon", "/manifest.webmanifest", "/icons")
